...
create table if not exists public.cards (
  ...
  minimum_payment_amount numeric(12,2) check (
...
create table if not exists public.debts (
  ...
  current_installment int not null default 1 check (current_installment > 0),
...
create table if not exists public.debt_payments (
  ...
  installment_number int check (installment_number is null or installment_number > 0),
  amount numeric(12,2) not null check (amount > 0),
